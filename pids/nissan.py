...
nissan_pids = [
	...
	[0x07E7E0,	'22111A',	'00',		'H02 B1 S2',	'V',	'0.0f',	linear,	[0.01, 0]	],		# !!! 
...
#	[0x07E7E0,	'221186',	'7F2212',	'',				'deg',	'0.3f',	linear,	[-1.0, 110] ],		# ?? always answers 7F2212 w/o command header
	...
	[0x07E7E0,	'221125',	'64',		'LTFT B1',		'%',	'0.0f',	linear,	[1.0, -100]	],		# A/F Ratio Adjustment (B1), offset=0x64, 1 = 1%
	[0x07E7E0,	'221126',	'84',		'LTFT B2',		'%',	'0.0f',	linear,	[1.0, -100]	],		# A/F Ratio Adjustment (B2), offset=0x64, 1 = 1%
	...
	[0x07E7E0,	'221139',	'20',		'Cam Duty B2',	'%',	'0.3f',	linear,	[1.0/2.56, 0]	],	# Camshaft Valve Duty Cycle (B2), 1 = 1/2.56 %
 	...
 	[0x07E7E0,	'22120C',	'0000',		'Fuel Pressure','bar',	'0.2f',	linear,	[0.01, 0]	],		# !!!
 	[0x07E7E0,	'22120D',	'01DA',		'Acc Pedal S1',	'V',	'0.2f',	linear,	[0.01, 0]	],		# !!!
 	[0x07E7E0,	'22120E',	'01DA',		'Acc Pedal S2',	'V',	'0.2f',	linear,	[0.01, 0]	],		# !!!
 	[0x07E7E0,	'22120F',	'01DA',		'TPS S1',		'V',	'0.2f',	linear,	[0.01, 0]	],		# !!!
 	[0x07E7E0,	'221210',	'01DA',		'TPS S2',		'V',	'0.2f',	linear,	[0.01, 0]	],		# !!!
 	[0x07E7E0,	'22121A',	'01DA',		'Car Speed',	'',		'0.0f',	linear,	[1.0, 0]	],		# !!!
